...
| CP-10 | `CP-10 MCP` | `pytest tests/test_mcp.py`; full `pytest`; lint/format/type | stdio client listed 15 tools and exercised exact section, hybrid search, and pack; 36 total tests passed; hostile fence stayed inert |
