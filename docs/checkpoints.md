...
| CP-11 | `CP-11 CLI` | `pytest tests/test_cli.py`; full `pytest`; `ctx --help`; lint/format/type; AGENTS word count | 4 CLI and 38 total tests passed; full init/add/index/search/section/pack workflow; template is 167 words |
