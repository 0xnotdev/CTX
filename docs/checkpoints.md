...
| CP-09 | `CP-09 checkpoints` | `pytest tests/test_checkpoints.py`; full `pytest`; lint/format/type | 2 checkpoint and 35 total tests passed; structured fields, exact source, graph context, and GENERATED artifact precedence verified |
